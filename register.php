...
if(isset($_POST['submit'])){
   ...
   if($select_users->rowCount() > 0){
      $warning_msg[] = 'cet email est deja pris !';
   }else{
      if($pass != $c_pass){
    ...
    <section class="form-container">
        ...
        <form action="" method="post">
            ...
            <input type="number" name="number" required min="0" max="9999999999" maxlength="10"
                placeholder="entrez votre numéro" class="box">
            <input type="password" name="pass" required maxlength="20" placeholder="entrez votre mot de passe"
                class="box">
            <input type="password" name="c_pass" required maxlength="20" placeholder="confirmez votre mot de passe"
                class="box">
