...
<body style="padding-left: 0;">
    ...
    <section class="form-container" style="min-height: 100vh;">
        ...
        <form action="" method="POST">
            ...
            <input type="text" name="name" placeholder="Saisissez votre nom d'utilisateur" maxlength="20" class="box"
                required oninput="this.value = this.value.replace(/\s/g, '')">
            <input type="password" name="pass" placeholder="Entrer le mot de passe" maxlength="20" class="box" required
