...
<body>
    ...
    <section class="listings">
        ...
        <h1 class="heading">listes des favories</h1>
      ...
      ?>
            ...
            ?>
                    <button type="submit" name="save" class="save"><i class="fas fa-heart"></i><span>enlever des
                            favories</span></button>
                    <?php
               }else{ 
            ?>
            ...
            ?>
                ...
                <div class="box">
                    ...
                    <div class="flex-btn">
                        <a href="view_property.php?get_id=<?= $fetch_property['id']; ?>" class="btn">voir la propriete
                        </a>
                        <input type="submit" value="envoyer la demande" name="send" class="btn">
                    </div>
                </div>
            </form>
            <?php
               ...
               echo '<p class="empty">auccune propriete ajouter pour le moment! <a href="post_property.php" style="margin-top:1.5rem;" class="btn">ajouter nouveau</a></p>';
            }
         }
      }else{
         echo '<p class="empty">aucune propriete ! <a href="listings.php" style="margin-top:1.5rem;" class="btn">découvrir plus</a></p>';
      }
      ?>
