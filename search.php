...
<body>
    ...
    <section class="filters" style="padding-bottom: 0;">
        ...
        <form action="" method="post">
            ...
            <div class="flex">
                <div class="box">
                    <p>entrer l'emplacement</p>
                    <input type="text" name="location" required maxlength="50" placeholder="entrez le nom de la ville"
                        class="input">
                </div>
                <div class="box">
                    <p>Type d'offre</p>
                ...
                <div class="box">
                    ...
                    <select name="furnished" class="input" required>
                        ...
                        <option value="furnished">Meublée</option>
                        <option value="semi-furnished">sémi équipé</option>
                    </select>
                </div>
            </div>
            <input type="submit" value="Recherche de propriété" name="filter_search" class="btn">
        </form>
...
?>
    ...
    <section class="listings">
      ...
      if(isset($_POST['h_search']) or isset($_POST['filter_search'])){
         ...
         echo '<h1 class="heading">Dernières annonces</h1>';
      }
   ?>
