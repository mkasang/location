...
if(isset($_POST['update'])){
   ...
   $success_msg[] = 'annonces modifier avec succes!';
...
<body>
   ...
   ?>
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="box">
                ...
                <input type="text" name="property_name" required maxlength="50"
                    placeholder="entrez le nom de la propriété" value="<?= $fetch_property['property_name']; ?>"
                    class="input">
            </div>
            <div class="flex">
                <div class="box">
                    ...
                    <input type="number" name="price" required min="0" max="9999999999" maxlength="10"
                        value="<?= $fetch_property['price']; ?>" placeholder="entrez le prix de la propriété"
                        class="input">
                </div>
                <div class="box">
                    <p>montant du dépôt <span>*</span></p>
                    <input type="number" name="deposite" required min="0" max="9999999999"
                        value="<?= $fetch_property['deposite']; ?>" maxlength="10"
                ...
                <div class="box">
                    <p>superficie habitable <span>*</span></p>
                    <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10"
                        placeholder="combien de pieds carrés ?" class="input" value="<?= $fetch_property['carpet']; ?>">
                </div>
                <div class="box">
                    <p>âge de la propriété <span>*</span></p>
                    <input type="number" name="age" required min="0" max="99" maxlength="2"
                        placeholder="quel âge a la propriété ?" class="input" value="<?= $fetch_property['age']; ?>">
                </div>
                <div class="box">
                ...
                <div class="box">
                    ...
                    <input type="number" name="room_floor" required min="0" max="99" maxlength="2"
                        placeholder="numéro de l'étage de la propriété" class="input"
            ...
            <div class="box">
                ...
                <textarea name="description" maxlength="1000" class="input" required cols="30" rows="10"
                    placeholder="écrivez sur la propriété..."><?= $fetch_property['description']; ?></textarea>
            </div>
            <div class="checkbox">
                <div class="box">
                    <p><input type="checkbox" name="lift" value="yes"
                            <?php if($fetch_property['lift'] == 'yes'){echo 'checked'; } ?> />ascenseur</p>
                    <p><input type="checkbox" name="security_guard" value="yes"
                            <?php if($fetch_property['security_guard'] == 'yes'){echo 'checked'; } ?> />gardien de
                        sécurité</p>
                    <p><input type="checkbox" name="play_ground" value="yes"
                            <?php if($fetch_property['play_ground'] == 'yes'){echo 'checked'; } ?> />aire de jeux</p>
                    <p><input type="checkbox" name="garden" value="yes"
                            <?php if($fetch_property['garden'] == 'yes'){echo 'checked'; } ?> />jardin</p>
                    <p><input type="checkbox" name="water_supply" value="yes"
                            <?php if($fetch_property['water_supply'] == 'yes'){echo 'checked'; } ?> />approvisionnement
                        en eau</p>
                    <p><input type="checkbox" name="power_backup" value="yes"
                            <?php if($fetch_property['power_backup'] == 'yes'){echo 'checked'; } ?> />alimentation de
                        secours</p>
                </div>
                <div class="box">
                    <p><input type="checkbox" name="parking_area" value="yes"
                            <?php if($fetch_property['parking_area'] == 'yes'){echo 'checked'; } ?> />zone de
                        stationnement</p>
                    <p><input type="checkbox" name="gym" value="yes"
                            <?php if($fetch_property['gym'] == 'yes'){echo 'checked'; } ?> />gymnase</p>
                    <p><input type="checkbox" name="shopping_mall" value="yes"
                            <?php if($fetch_property['shopping_mall'] == 'yes'){echo 'checked'; } ?> />centre commercial
                    </p>
                    <p><input type="checkbox" name="hospital" value="yes"
                            <?php if($fetch_property['hospital'] == 'yes'){echo 'checked'; } ?> />hôpital</p>
                    <p><input type="checkbox" name="school" value="yes"
                            <?php if($fetch_property['school'] == 'yes'){echo 'checked'; } ?> />école</p>
                    <p><input type="checkbox" name="market_area" value="yes"
                            <?php if($fetch_property['market_area'] == 'yes'){echo 'checked'; } ?> />zone de marché</p>
                </div>
            </div>

            <div class="box">
                <img src="uploaded_files/<?= $fetch_property['image_01']; ?>" class="image" alt="">
                <p>mettre a jour l'image 01</p>
            ...
            <div class="flex">
                <div class="box">
                    ...
                    <input type="submit" value="supprimer l'image 02" name="delete_image_02" class="inline-btn"
                        onclick="return confirm('supprimer l\'image 02 ?');">
                    <?php } ?>
                    <p>mettre à jour l'image 02</p>
                ...
                <div class="box">
                    ...
                    <input type="submit" value="supprimer l'image 03" name="delete_image_03" class="inline-btn"
                        onclick="return confirm('supprimer l\'image 03 ?');">
                    <?php } ?>
                    <p>mettre à jour l'image 03</p>
                ...
                <div class="box">
                    ...
                    <input type="submit" value="supprimer l'image 04" name="delete_image_04" class="inline-btn"
                        onclick="return confirm('supprimer l\'image 04 ?');">
                    <?php } ?>
                    <p>mettre à jour l'image 04</p>
                ...
                <div class="box">
                    ...
                    <input type="submit" value="supprimer l'image 05" name="delete_image_05" class="inline-btn"
                        onclick="return confirm('supprimer l\'image 05 ?');">
                    <?php } ?>
                    <p>mettre à jour l'image 05</p>
      ...
      echo '<p class="empty">auccune propriete trouvee ! <a href="post_property.php" style="margin-top:1.5rem;" class="btn">add new</a></p>';
   }
   ?>
